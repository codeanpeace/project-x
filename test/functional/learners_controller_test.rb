...
class LearnersControllerTest < ActionController::TestCase
  ...
  test "should create learner" do
    assert_difference('Learner.count') do
      post :create, learner: { first_name: @learner.first_name, grade: @learner.grade, last_name: @learner.last_name }
    end
  ...
  test "should update learner" do
    put :update, id: @learner, learner: { first_name: @learner.first_name, grade: @learner.grade, last_name: @learner.last_name }
    assert_redirected_to learner_path(assigns(:learner))
  end
